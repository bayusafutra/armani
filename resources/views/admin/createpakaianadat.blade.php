...
@section('container')
    <div class="container mt-5">
        ...
        <div class="card-body">
            <form action="/pakaianadatcreate" method="POST">
                @method("post")
                @csrf
                <div class="mb-3">
                    <label for="Nama" class="form-label">Nama Pakaian Adat</label>
                    <input type="text" class="form-control" name=name_pakaian>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name=deskripsi_pakaian>
                </div>
