...
@section('container')
    <div class="container mt-5">
        ...
        <div class="card-body">
            <form action="/rumahadatcreate" method="POST">
                @method("post")
                @csrf
                <div class="mb-3">
                    <label for="Nama" class="form-label">Nama Rumah Adat</label>
                    <input type="text" class="form-control" name=name_rumahadat>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name=deskripsi_rumah_adat>
                </div>
