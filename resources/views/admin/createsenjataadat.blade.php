...
@section('container')
    <div class="container mt-5">
        ...
        <div class="card-body">
            <form action="/senjataadatcreate" method="POST">
                @method("post")
                @csrf
                <div class="mb-3">
                    <label for="Nama" class="form-label">Nama Senjata Daerah</label>
                    <input type="text" class="form-control" name=name_senjata>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name=deskripsi_senjata>
                </div>
