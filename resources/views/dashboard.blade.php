...
<html lang="en">
  <head>
    ...
    <!-- End layout styles -->
    <link rel="shortcut icon" href="img/labelmini.png" />
  </head>
  <body>
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          ...
          <a class="sidebar-brand brand-logo-mini" href=""><img src="img/labelmini.png" alt="logo" /></a>
        </div>
        <ul class="nav">
            ...
            <div class="row ">
              <div class="col-12 grid-margin">
                <div class="erga">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title" style="text-align: center">SELAMAT DATANG ARMANI'S ADMIN</h4>
