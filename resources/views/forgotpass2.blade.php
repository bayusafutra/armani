    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col col-xl-11">
        <div class="card mt-5" style="border-radius: 1rem;">
          <div class="row g-3">
            <div class="col-md-3 col-lg-5 d-none d-md-block" style="height: 200px">
              ...
              <div class="card-body p-4 p-lg-5 text-black">
                <form>
                  ...
                  <div class="form-outline mb-4">
                    ...
                    <label class="form-label" for="form2Example17">Code OTP
                  </div>
                  <div class="form-outline mb-4">
                    <input type="email" id="form2Example17" class="form-control form-control-lg" />
                  ...
                  <div class="pt-1 mb-4">
                    <a class="btn btn-dark btn-lg btn-block" href="/login" type="button">Update Password</a>
                  </div>
                </form>
    ...
    <div class="row d-flex justify-content-center align-items-center h-100" >
      <div class="col col-xl-11">
        <div class="card" style="border-radius: 1rem ;">
          <div class="row g-3" style="background-color: #42855B">
            <div class="col-md-3 col-lg-5 d-none d-md-light" style="height: 200px;">
              <img src="/img/login.jpg"
            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <!-- <form>
                  ...
                  <div class="pt-1 mb-4">
                    <a class="btn btn-dark btn-lg btn-block" href="/login" type="button">Register</a>
                  </div>
                </form> -->
...
<head>
    ...
    <title>Armani Forgot Password</title>
