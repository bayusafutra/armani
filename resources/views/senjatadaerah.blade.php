            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <article>
                        ...
                        <header class="mb-4">
                            <!-- Post title-->
                            <h1 class="fw-bolder mb-1">{{ $senjatadaerah[0]->name_senjata }}</h1>
                            <h6>Based on {{ $senjatadaerah[0]->province->name_provinsi }}</h6>
                            <!-- Post meta content-->
                            <div class="text-muted fst-italic mb-2">Posted on {{ $senjatadaerah[0]->created_at->diffForHumans() }} by {{ $senjatadaerah[0]->user->name }}</div>
                            <!-- Post categories-->
                            <!-- <a class="badge bg-secondary text-decoration-none link-light" href="#!">Web Design</a>
                            <a class="badge bg-secondary text-decoration-none link-light" href="#!">Freebies</a> -->
                        </header>
                        <!-- Preview image figure-->
                        @if (strlen($senjatadaerah[0]->gambar)>50)
                            <figure class="mb-4"><img class="img-fluid rounded" src="{{ asset('storage/'.$senjatadaerah[0]->gambar) }}" style="width:900px; height:350px" alt="..." /></figure>
                        @else
                            <figure class="mb-4"><img class="img-fluid rounded" src="/img/senjata/{{ $senjatadaerah[0]->gambar }}" style="width:900px; height:350px" alt="..." /></figure>
                        @endif
                        <!-- Post content-->
                        <section class="mb-5">
