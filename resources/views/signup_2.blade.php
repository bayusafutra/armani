        ...
        <div class="card" style="border-radius: 1rem;">
          <div class="row g-0">
            <div class="col-md-6 col-lg-5 d-none d-md-block">
              <img src="/img/login.jpg" style="height: 608px"
              ...
              <div class="card-body p-4 p-lg-5 text-black">
                ...
                <form>
                  ...
                  <div class="d-flex align-items-center mb-3 pb-1">
                    ...
                    <span class="h1 fw-bold mb-0">ARMANI SERU</span>
                  </div>
                  ...
                  <div class="form-outline mb-4">
                    <input type="confirm" id="form2Example27" class="form-control form-control-lg" />
                    <label class="form-label" for="form2Example27">Confirm Password</label>
                  </div>

                  <div class="pt-1 mb-4">
                    <a class="btn btn-dark btn-lg btn-block" href="/login" type="button">Register Account</a>
                  </div>
                </form>
