                ...
                <div class="col-lg-8">
                    ...
                    <article>
                        ...
                        @if (strlen($sukuadat[0]->gambar)>50)
                            <figure class="mb-4"><img class="img-fluid rounded" src="{{ asset('storage/'.$sukuadat[0]->gambar) }}" style="width:900px; height:350px" alt="..." /></figure>
                        @else
                            <figure class="mb-4"><img class="img-fluid rounded" src="/img/sukuadat/{{ $sukuadat[0]->gambar }}" style="width:900px; height:350px;" alt="..." /></figure>
                        @endif
                        <!-- Post content-->
                        <section class="mb-5">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="input-group">
                                ...
                                <button class="btn btn-success" style="background-color: #52B788; color:black" id="button-search" type="button">Seacrh</button>
                            </div>
                        </div>
                    </div>
                    <!-- Categories widget-->
